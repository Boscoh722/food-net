      ...
      <div className="max-w-md w-full bg-white rounded-2xl shadow-2xl overflow-hidden animate-fade-in">
        ...
        <div className="p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {/* Role Selection */}
            <div>
              <label className="block text-sm font-semibold text-gray-700 mb-4">Select Role</label>
              <div className="grid grid-cols-3 gap-4">
                {roleOptions.map((role) => (
                  <button
                    ...
                    className={`p-4 rounded-2xl border transition-all duration-300 text-center shadow-lg hover:shadow-xl ${
            ...
            {form.role === 'logistics' && (
              <div className="grid md:grid-cols-2 gap-6 animate-fade-in">
                ...
                <div>
                  <label className="block text-sm font-semibold text-gray-700 mb-2">Service Reach</label>
                  <div className="relative">
                    <MapPin className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 w-5 h-5" />
                    <input
                      type="text"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full px-6 py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-xl hover:from-blue-700 hover:to-purple-700 transition-all duration-300 shadow-lg hover:shadow-xl disabled:opacity-50"
            >
