...
import { ShoppingCart, Package, Truck, DollarSign, AlertTriangle, RefreshCw, Clock, CheckCircle, MapPin, Eye } from 'lucide-react';
...
const ProductCard = ({ product, onViewDetails, onOrder }) => (
  <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200 transition-all duration-300 hover:shadow-md hover:border-blue-300">
    ...
    <div className="space-y-3">
      <div className="bg-green-50 rounded-xl p-3 border border-green-200">
        <p className="text-green-700 font-bold text-xl">KSh {product.price?.toLocaleString()}</p>
        <p className="text-sm text-green-600">per {product.unit}</p>
      </div>

      <div className="flex items-center justify-between text-sm">
        <span className="text-gray-600">Stock: {product.quantityInStock}</span>
      ...
      <div className="flex gap-2 mt-4">
        <button
          ...
          className="flex-1 px-3 py-2 bg-blue-600 text-white rounded-xl hover:bg-blue-700 transition-colors font-medium flex items-center justify-center gap-2"
        >
        ...
        <button
          ...
          className="flex-1 px-3 py-2 bg-green-600 text-white rounded-xl hover:bg-green-700 transition-colors font-medium flex items-center justify-center gap-2"
        >
